  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
      <div className="glass-card p-8 max-w-lg border border-red-500/30">
        ...
        <h2 className="text-2xl font-semibold text-red-300 mb-3">Error Loading Property</h2>
        <p className="text-gray-400 mb-6">
          We could not load the details for this property. It might be temporarily unavailable or the link might be incorrect.
        </p>
